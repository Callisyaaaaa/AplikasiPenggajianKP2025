    ...
    <div class="container mt-4">
        ...
        <ul class="nav nav-tabs mb-3" id="absensiTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="tabel-tab" data-bs-toggle="tab" data-bs-target="#tabel" type="button"
                    role="tab">Tabel Umum</button>
            </li>
            @if (auth()->user()->role === 'Admin' || auth()->user()->role === 'Pimpinan')
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="rekap-tab" data-bs-toggle="tab" data-bs-target="#rekap" type="button"
                        role="tab">Rekap Per Pegawai</button>
                </li>
            @endif
        </ul>
        ...
        <div class="tab-content" id="absensiTabContent">
            ...
            <div class="tab-pane fade show active" id="tabel" role="tabpanel" aria-labelledby="tabel-tab">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($absensi->status === 'Hadir' && $absensi->attendance_photo)
                                            <a href="{{ asset('storage/' . $absensi->attendance_photo) }}"
                ...
                <div class="col-md-2">
                    <a href="{{ route('absensi.riwayat.download', request()->query()) }}" class="btn btn-danger">Download
                        PDF</a>
                </div>
            </div>
