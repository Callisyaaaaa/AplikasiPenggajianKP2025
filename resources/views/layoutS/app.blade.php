...
<head>
    ...
    <title> PT SARINA INDIKA MAKMUR </title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="dropdown d-flex align-items-center justify-content-start px-3 my-4">
            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->role) }}&background=random&color=fff"
                alt="{{ Auth::user()->role }}" width="50" height="50" class="rounded-circle me-2">

            <a class="d-block text-decoration-none text-white dropdown-toggle" id="dropdownUser"
        ...
        <div class="header">
            <span class="brand">PT SARINA INDIKA MAKMUR</span>
        </div>
            ...
            @if (auth()->user()->role == 'Admin')
                ...
                <li class="nav-item">
                    <a href="{{ url('/riwayat-absensi') }}"
                        class="nav-link {{ request()->is('riwayat-absensi') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ url('/riwayat-gaji') }}"
                        class="nav-link {{ request()->is('riwayat-gaji') ? 'active' : '' }}">
